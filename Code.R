...
nga_pop <- rast("\\Users\\User\\Documents\\GIS\\walkshed\\NGA_ppp_v2c_2020_UNadj.tif")
...
standard_track_gauge_light_rail<-nigeria_rails %>% dplyr::filter(gauge %in% c(1435,1067)) #filter standard gauge railway lines
...
#convert to html to be used in leafle
...
saveWidget(walkshed,'walkshed.html')
